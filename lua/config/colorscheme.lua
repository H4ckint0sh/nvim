...
-- Hackvim Colors
vim.api.nvim_set_hl(0, "HackvimPrimary", { fg = "#488dff" })
vim.api.nvim_set_hl(0, "HackvimSecondary", { fg = "#FFA630" })

vim.api.nvim_set_hl(0, "HackvimPrimaryBold", { bold = true, fg = "#488DFF" })
vim.api.nvim_set_hl(0, "HackvimSecondaryBold", { bold = true, fg = "#FFA630" })

vim.api.nvim_set_hl(0, "HackvimHeader", { bold = true, fg = "#488DFF" })
vim.api.nvim_set_hl(0, "HackvimHeaderInfo", { bold = true, fg = "#FFA630" })
vim.api.nvim_set_hl(0, "HackvimFooter", { bold = true, fg = "#FFA630" })

vim.api.nvim_set_hl(0, "HackvimNvimTreeTitle", { bold = true, fg = "#FFA630"})

-- Tokyonight Colorscheme Specific Config
if Hackvim.colorscheme == "tokyonight" then
  -- Lines
  vim.api.nvim_set_hl(0, "CursorLineNR", { link = "HackvimSecondary" })
  ...
  vim.api.nvim_set_hl(0, "BufferOffset", { link = "HackvimSecondary" })
